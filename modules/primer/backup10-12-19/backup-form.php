    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/primer/proses.php?act=insert" method="POST">
            <div class="box-body">
              <?php  
              ...
              <div class="form-group ">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-sm-5">
                            ...
                            <option value="volverallamar" style="color:#DF3A01;">Volver a llamar</option>
