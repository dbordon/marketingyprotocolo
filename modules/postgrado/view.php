...
<section class="content">
  <div class="row">
    ...
    ?>
      <h1>Seguimiento a preinscriptos - Programas de postgrado</h1>
      ...
      <th scope=col>Acción</th>
            ...
            <?php  
            $no = 1;
            $query = mysqli_query($mysqli, "SELECT *FROM v_postgrado_sseg;")
           ...
           $apellidos= $data['apellidos'];
              ...
              <td width='10' class='center' style='color:#298A08; font-size:20px' >$data[estado]</td>
                      <td class='center' width='1'>
		                <div>
		                  <a data-toggle='tooltip' data-placement='top' title='Realizar Seguimiento' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_postgrado&form=edit&id=$data[id_inter_postgrado]'>
