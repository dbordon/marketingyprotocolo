...
if ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT *FROM v_segudo_llamdo where id_interesado='$_GET[id]'") 
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=segundo"> Segundo seguimiento</a></li>
                ...
                <div class="col-sm-5">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-sm-5">
                            ...
                            <option value="tercerllamado" style="color:#DF3A01; font-size:20px">Tercer llamado</option>
