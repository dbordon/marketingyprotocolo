    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/postulantes/proses.php?act=insert" method="POST">
            <div class="box-body">
              <?php  
...
echo "</option>";            
        ...
        ?>
                      ...
                      <div class="form-group">
                            <label class="col-sm-2 control-label" for="carrera">Medio de Contacto</label>
                            <div class="col-sm-5">
                            <select name="medio"  class="form-control">
        <?php
          include '../../config/database.php';

            $query=mysqli_query($mysqli, "select *from medio_contacto");             
            

            while($dato= mysqli_fetch_assoc($query))

            {                 
                echo "<option value='".$dato['id_medio']."'";
                    if($_POST['medio']==$dato['id_medio'])
                echo "SELECTED";
                echo ">";
                echo utf8_encode($dato['descrip_medio']);
                echo "</option>";            
            }
        ?>
        </select>
...
?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Modificar Postulantes
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=postulantes"> Postulantes </a></li>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/postulantes/proses.php?act=update" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Colegio</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="colegio" autocomplete="off"  value=" <?php echo $data['colegio']; ?>" >
                </div>
              </div>
