...
if ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT *FROM v_postgrado where id_inter_postgrado='$_GET[id]' and estado='CONFIRMADO'") 
...
?>
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=confirmadospostgrado"> Lista de Confirmados </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/confirmadospostgrado/proses.php?act=update" method="POST">
            <div class="box-body">
