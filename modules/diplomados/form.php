...
if ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT *FROM v_diplomado_sseg where id_inter_diplomado='$_GET[id]'") 
...
?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Contacto vía Web - Diplomados
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=diplomados"> Diplomados </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/diplomados/proses.php?act=update" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="codigo" value="<?php echo $data['id_inter_diplomado']; ?>" readonly required>
                </div>
              </div>
            ...
            <div class="form-group">
            <label class="col-sm-2 control-label">Respuesta obtenida</label>
                <div class="col-sm-5">
                  <textarea class="form-control" name="respuesta" rows="5" id="comment"></textarea>
                </div>
            </div>
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="?module=diplomados" class="btn btn-default btn-reset">Cancelar</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
