...
<section class="content">
  <div class="row">
    ...
    ?>
      <h1>2° Seguimiento a preinscriptos</h1>
      ...
      <th scope=col>Acción</th>
            ...
            if(!empty($id_sede)){
              ...
              FROM interesados i, sedes a, carreras c WHERE i.id_sede=a.id_sede and estado='VOLVERALLAMAR' and  c.id_carreras=i.id_carreras AND i.id_sede=$id_sede")
              or die('error: '.mysqli_error($mysqli));
            }else {
              $query = mysqli_query($mysqli, "SELECT  id_interesado, a.descrip_sede, nombres, apellidos,  telefono,  fecha_carga, estado
              FROM interesados i, sedes a, carreras c WHERE i.id_sede=a.id_sede and estado='VOLVERALLAMAR' and  c.id_carreras=i.id_carreras")
              or die('error: '.mysqli_error($mysqli));
            }    
           ...
           $sededescrip= utf8_encode($data['descrip_sede']);
              ...
              <td width='10' class='center' style='color:#298A08; font-size:20px' >$data[estado]</td>
                      <td class='center' width='1'>
		                <div>
		                  <a data-toggle='tooltip' data-placement='top' title='Realizar el 2° seguimiento' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_segundo&form=edit&id=$data[id_interesado]'>
