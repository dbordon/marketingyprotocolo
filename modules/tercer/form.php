...
if ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT *FROM v_tercer_llamdo where id_interesado='$_GET[id]'") 
...
<section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> 3° Seguimiento  
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=tercer"> Tercer seguimiento</a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/tercer/proses.php?act=update" method="POST">
            <div class="box-body">
