...
?>
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=colegios"> Visita a colegios </a></li>
          ...
          <form role="form" class="form-horizontal" action="modules/colegios/proses.php?act=update" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="telefono" autocomplete="off"  onKeyPress="return goodchars(event,'0123456789',this)" value="<?php echo $data['telefono']; ?>" require>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Comentarios del primer seguimiento</label>
                <div class="col-sm-5">
                <textarea class="form-control" name="comentario" rows="5" ><?php echo $data['obs']?></textarea>
                </div>
              </div>
