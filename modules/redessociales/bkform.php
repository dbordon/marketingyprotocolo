...
if ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT id_interesado, a.descrip_sede,c.descrip_carrera, 
      nombres, apellidos, cedula, telefono, email, colegio, fecha_carga, anho, 
      comentarios, estado, d.descrip_medio
