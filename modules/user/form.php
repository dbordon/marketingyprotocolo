          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/user/proses.php?act=insert" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Nombre de usuario de sistema</label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select class="chosen-select" name="id_sede" data-placeholder="-- Seleccionar  Sede --"
                                    autocomplete="off">
                                        <option value=""></option>
                                        <?php 
                                            ...
                                            while ($data_prov = mysqli_fetch_assoc($query_prov)){
                                              $sede=utf8_encode($data_prov['descrip_sede']);
                                                echo "<option value=\"$data_prov[id_sede]\">$data_prov[id_sede] | $sede</option>";
                                            }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                          <input class="form-check-input" type="checkbox" name="sinssede" >
                          <label class="form-check-label">Sin Sede</label>
                        </div>
              <div class="form-group">
...
?>
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="?module=user"><i class="fa fa-home"></i> Inicio</a></li>
      <li><a href="?module=user"> Usuario </a></li>
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                                  ...
                                  <div class="col-sm-5">
                                      <select class="chosen-select" name="id_sede" data-placeholder="-- Seleccionar  Sede --"
                                      autocomplete="off">
                                          <option value="<?php echo $data['id_sede']; ?>"><?php echo $data['id_sede']; ?></option>
                                          <?php 
                                              $query_prov = mysqli_query($mysqli, "SELECT id_sede, descrip_sede
                                              FROM sedes
                                              ORDER BY id_sede ASC") or die ('Error'.mysqli_error($mysqli));
                          ...
                          <input class="form-check-input" type="checkbox" name="sinsede" >
                          <label class="form-check-label">Sin Sede</label>
