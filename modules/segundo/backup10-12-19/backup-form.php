    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/segundo/proses.php?act=insert" method="POST">
            <div class="box-body">
              <?php  
              ...
              <div class="form-group ">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-sm-5">
                            ...
                            <option value="Concluido" style="color:#3ADF00;">Concluido</option>
                            <option value="inactivo" style="color:#000000;">Rechazado</option>
                          </select>  
                      </div>
