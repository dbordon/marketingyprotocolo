...
if ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT id_interesado, a.id_sede, a.descrip_sede,c.descrip_carrera, o_carrera, nombres, apellidos, cedula, telefono, email, colegio, fecha_carga, anho, comentarios, estado, d.descrip_medio
FROM interesados i, sedes a, carreras c, medio_contacto d
WHERE i.id_sede=a.id_sede and estado in('redessociales','expo') and c.id_carreras=i.id_carreras and id_interesado='$_GET[id]'") 
...
?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Contacto vía Web  
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=redessociales"> Redes sociales </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/redessociales/proses.php?act=update" method="POST">
            <div class="box-body">
              ...
              <div align="center" class="form-group">
                <div class="col-sm-9">
                <p><strong>Observaciones: </strong>Se deben corroborar los datos del interesado (Nombres, apellidos, teléfono, etc)</p> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="medio" class="form-control" name="medio" autocomplete="off" disabled value="<?php echo $data['descrip_medio']; ?> " >
                </div>
              </div>              

              <div class="form-group">
                <label class="col-sm-2 control-label">Comentarios del Interesado</label>
                <div class="col-sm-5">
                <textarea class="form-control" name="comentario_interesados" rows="5" disabled><?php echo $data['comentarios']; ?></textarea>
                </div>
              </div>

              <div class="form-group">
                <label class="col-sm-2 control-label">Comentario del seguimiento</label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="medio" class="form-control" name="medio" autocomplete="off" disabled value="<?php echo utf8_encode($data['descrip_carrera']); ?> " >
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Otra Carrera</label>
                <div class="col-sm-5">
                  <input type="medio" class="form-control" name="medio" autocomplete="off" disabled value="<?php echo $data['o_carrera']; ?> " >
                </div>
              </div>              
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Sede</label>
                      <div class="col-sm-5">
                                    ...
                                    <option value="<?php echo $data['id_sede']; ?>"><?php echo utf8_encode($data['descrip_sede']); ?></option>
                                        <?php
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="?module=redessociales" class="btn btn-default btn-reset">Cancelar</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
