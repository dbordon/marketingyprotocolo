...
<section class="content-header">
  <h1>
    <i class="fa fa-file-text-o icon-title"></i> Lista de confirmados por rango de fechas
  </h1>
  <ol class="breadcrumb">
    <li><a href="?module=start"><i class="fa fa-home"></i> Inicio</a></li>
    <li class="active">informe</li>
    <li class="active"> Lista de confirmados por rango de fechas</li>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" method="GET" action="modules/reportes2/print.php" target="_blank">
          <div class="box-body">
