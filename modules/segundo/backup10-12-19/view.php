           ...
           //   $precio_venta = format_rupiah($data['precio_venta']);
              ...
              echo "<tr>
                      ...
                      <td class='center' width='80'>
		                <div>
		                  <a data-toggle='tooltip' data-placement='top' title='modificar' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_segundo&form=edit&id=$data[id_interesado]'>
