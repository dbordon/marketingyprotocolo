...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
	...
	if ($_GET['act']=='insert') {
		if (isset($_POST['Guardar'])) {
			...
			if(empty($_POST['sinsede'])){
				$id_sede = $_POST['id_sede'];
			}
			$id_sede = "(NULL)";

            $query = mysqli_query($mysqli, "INSERT INTO usuarios(username,password,name_user,permisos_acceso, id_sede)
                                            VALUES('$username','$password','$name_user','$permisos_acceso',$id_sede)")
