...
?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i>Confirmados
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=confirmados"> Confirmados </a></li>
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/confirmados/proses.php?act=update" method="POST">
            <div class="box-body">
...
?>
              ...
              <div class="form-group ">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-sm-5">
                            ...
                            <option value="inscripto" style="color:#3ADF00;">Inscripto</option>
                          </select>  
                      </div>
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <input type="submit" class="btn btn-primary btn-submit" name="Guardar" value="Guardar">
                  <a href="?module=confirmados" class="btn btn-default btn-reset">Cancelar</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
