...
WHERE i.id_sede=a.id_sede and estado='VOLVERALLAMAR' and  c.id_carreras=i.id_carreras and id_interesado='$_GET[id]'") 
...
?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> 2° Seguimiento
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=segundo"> Postulantes </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/segundo/proses.php?act=update" method="POST">
            <div class="box-body">
                            ...
                            <div class="col-sm-5">
                                    <select name="carrera"  class="form-control">
                                            ...
                                            while ($dato = mysqli_fetch_assoc($query)) {
                                                ...
                                                if (isset($_POST['carrera']) == $dato['id_carreras'])
                                                    echo "SELECTED";
                                                echo ">";
...
<script>
    function conv() {
        if ($("#estado").val() == 'Concluido') {            
                $.ajax({
                    type:"GET",
                    url:"/postulantes/modules/primer/convocatoria/?ano="+$("#anho").val()+"&id_sede="+$("#sede").val(),
                    beforeSend: function(){
    ...
    function cursos() {        
                $.ajax({
                    type:"GET",
                    url:"/postulantes/modules/primer/curso/?ano="+$("#anho").val()+"&id_sede="+$("#sede").val()+"&id_carre="+$("#carre").val(),
                    beforeSend: function(){
    ...
    function turnos() {        
                $.ajax({
                    type:"GET",
                    url:"/postulantes/modules/primer/turno/?ano="+$("#anho").val()+"&id_sede="+$("#sede").val()+"&id_carre="+$("#carre").val()+"&id_curso="+$("#curso").val(),
                    beforeSend: function(){
    ...
    function modalidades() {        
                $.ajax({
                    type:"GET",
                    url:"/postulantes/modules/primer/modalidad/?ano="+$("#anho").val()+"&id_sede="+$("#sede").val()+"&id_carre="+$("#carre").val()+"&id_curso="+$("#curso").val()+"&id_turno="+$("#turno").val(),
                    beforeSend: function(){
    ...
    function convocatorias() {        
                $.ajax({
                    type:"GET",
                    url:"/postulantes/modules/primer/convo_iden/?ano="+$("#anho").val()+"&id_sede="+$("#sede").val()+"&id_carre="+$("#carre").val()+"&id_curso="+$("#curso").val()+"&id_turno="+$("#turno").val()+"&id_tipocon="+$("#modalidad").val(),
                    beforeSend: function(){
