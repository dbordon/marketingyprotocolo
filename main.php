...
<html>
  <head>
    <meta charset="UTF-8">
    <title>UTIC | Marketing | D.T.I</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Sistema de postulación">
    <meta name="author" content="Sistema de postulación - Dbordon" />
  ...
  <body class="skin-blue fixed" >
    <div class="wrapper">
      ...
      <p>                   
                        ...
                        </script> Todos los derechos reservados | UTIC | D.T.I | <a href="https://www.linkedin.com/in/nelson-daniel-bord%C3%B3n-ag%C3%BCero-17417b16b/"><i class="fa fa-linkedin-square"></a></i><!--<i class="icon-heart" aria-hidden="false"></i> by <a href="#" target="_blank">Web Master</a>-->                        
                    </p>
      </footer>
