...
Highcharts.chart('container', {
    ...
    title: {
        text: '<?php
            $sql="SELECT COUNT(*) AS cantidad FROM v_seg_desercion_reincorporado";
            $resultado = mysqli_query($mysqli, $sql);
                    while($row = mysqli_fetch_array($resultado))
                    {
                        ?>
                        <?php echo "Cantidad total de Reincorporados por sede:  ".$row['cantidad']?>
                        <?php echo "<br>"?>
                        <?php  $time = time(); ?>
