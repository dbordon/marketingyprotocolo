<section class="content-header">
  <h1>
    <section class="content-header">
    <h1>
    <i class="fa fa-folder-o icon-title"></i> Seguimiento de estudiantes en estado de Deserción
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li class="active"><a href="?module=desercionseguimiento"> Seguimiento Deserción </a></li>
  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 1) {
      echo "<div class='alert alert-success alert-dismissable'>
            ...
            Nuevos datos de Seguimiento de  deserciones han sido almacenados correctamente.
            </div>";
    }
    ...
    elseif ($_GET['alert'] == 4) {
      echo "<div class='alert alert-success alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4>  <i class='icon fa fa-check-circle'></i> Exito!</h4>
            Derivado para el 2° seguimiento
            </div>";
    }
    ?>
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <?php  
            $no = 1;
            $query = mysqli_query($mysqli, "SELECT *FROM v_desercion;")
           ...
           $sacademica = $data['sacademica'];
              ...
              echo "<tr>
                      ...
                      <td class='center' width='80'>
		                <div>
		                  <a data-toggle='tooltip' data-placement='top' title='Realizar Seguimiento' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_desercionseguimiento&form=edit&id=$data[cod_desercion]'>
