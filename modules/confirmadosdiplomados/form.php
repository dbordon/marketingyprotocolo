...
if ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT *FROM v_diplomado where id_inter_diplomado='$_GET[id]' and estado='CONFIRMADO'") 
...
?>
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Confirmados - Programas de postgrados
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
      <li><a href="?module=confirmadosdiplomados"> Lista de Confirmados </a></li>
      <li class="active"> Ver Confirmados </li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/confirmadosdiplomados/proses.php?act=update" method="POST">
            <div class="box-body">
                ...
                <div class="col-sm-5">
                      ...
                      <div class="form-group ">
                        ...
                        <div class="col-sm-5">
                            ...
                            <option value="VOLVERALLAMAR" style="color:#3ADF00; font-size:20px">Volver a llamar</option>
            ...
            <div class="box-footer">
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  ...
                  <a href="?module=confirmadospostgrado" class="btn btn-default btn-reset">Cancelar</a>
                </div>
              </div>
            </div><!-- /.box footer -->
          </form>
