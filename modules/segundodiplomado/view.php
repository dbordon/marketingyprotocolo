  ...
  <div class="row">
    ...
    ?>
      ...
      <th scope=col>Acción</th>
            ...
            <?php  
            $no = 1;
            $query = mysqli_query($mysqli, "SELECT *FROM v_diplo_segundo_seg;")
           ...
           $apellidos= $data['apellidos'];
              ...
              <td width='10' class='center' style='color:#298A08; font-size:20px' >$data[estado]</td>
                      <td class='center' width='1'>
		                <div>
		                  <a data-toggle='tooltip' data-placement='top' title='Realizar Seguimiento' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_segundodiplomado&form=edit&id=$data[id_inter_diplomado]'>
