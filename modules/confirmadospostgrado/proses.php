    ...
    if ($_GET['act']=='update') {
        if (isset($_POST['Guardar'])) {
            if (isset($_POST['codigo'])) {
                ...
                $query = mysqli_query($mysqli, "UPDATE interesados_postgrado SET nombres = '$nombre',
                                                                    apellidos = '$apellidos',
                                                                    cedula = '$cedula',
                                                                    telefono = '$telefono',
                                                                    email = '$correo',
                                                              ...
                                                              WHERE id_inter_postgrado = $codigo")
                ...
                if ($query) {
                    ...
                    header("location: ../../main.php?module=confirmadospostgrado&alert=2");
                }         
            }
        }
    }
